...
{
    internal class ODataSparqlServiceConfiguration
    {
        ...
        public ODataSparqlServiceConfiguration(string name, HttpServerUtility server)
        {
            Name = name;
            _server = server;
        ...
        private void ReadEndpointMetadata(SparqlEndpointConfigurationElement endpoint)
        {
            ...
            Map = new SparqlMap(configPath, endpoint.DefaultMapping);
        }
